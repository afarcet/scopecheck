        ...
        <div style={{ border: '1px solid var(--border2)', background: 'var(--bg2)' }}>
          ...
          <div style={{ padding: '24px' }}>
            ...
            <div style={{ display: 'flex', gap: '6px', alignItems: 'center', flexWrap: 'wrap' }}>
              <Link href={`/i/${handle}/apply`} style={{ flex: 1, display: 'flex', justifyContent: 'center', background: 'var(--rasp)', color: '#fff', border: '1px solid var(--rasp)', fontFamily: "'JetBrains Mono', monospace", fontSize: '11px', fontWeight: 700, letterSpacing: '0.06em', padding: '9px 16px', textDecoration: 'none', alignItems: 'center' }}>
                $ apply →
              </Link>
