        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem", marginBottom: "1.2rem" }}>
            ...
            <div>
              ...
              <input type="url" className="input" placeholder="https://linkedin.com/in/..." value={form.linkedin_url || ""} onChange={(e) => handleChange("linkedin_url", e.target.value)} />
            </div>
          </div>

          {/* Team background */}
          <div style={{ marginBottom: "1.2rem" }}>
            <label className="label">Team / founder background</label>
            <textarea className="input" rows={2} style={{ resize: "vertical" }} placeholder="2x founders, ex-Siemens + MIT, 15yrs in industrial automation" value={form.founder_background || ""} onChange={(e) => handleChange("founder_background", e.target.value)} />
          </div>

          {/* What we want */}
          <div style={{ marginBottom: "1.2rem" }}>
            <label className="label">What are you looking for in investors?</label>
            <textarea className="input" rows={2} style={{ resize: "vertical" }} placeholder="Sector expertise in industrial decarbonisation, intro to utilities" value={form.what_we_want || ""} onChange={(e) => handleChange("what_we_want", e.target.value)} />
          </div>

          {/* Lead investor + data room row */}
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem", marginBottom: "1.2rem" }}>
            <div>
